...
<div className="container" style={{marginTop:"150px",paddingTop:"50px",backgroundColor:"#f5f0f0"}}>
   ...
   <li>Quick integration: Our digital payment products are designed for flawless integration. It is developer-friendly in their construction and implementation, and can be swiftly and seamlessly <br></br>incorporated into your existing system.</li>
    ...
    <p style={{color:"#665d5d",fontSize:"small"}} >
      ...
      <li>
Diverse payment modes: Zaakpay assists its merchants to collect payments via diverse modes, be it UPI which is direct bank to bank transfer, credit or debit cards, mobile wallets like<br></br> MobiKwik, international cards or pay later like facilities.</li>
...
<div className="container" style={{marginTop:"70px"}}>
  <div className="row">
      <div className="col-md-4 col-sm-12">
        <img src="https://zaakpay.com/assets/images/main-logo.svg"></img>
