...
export default  class CashBackComponent extends Component {
    constructor(props){
        super(props)
    this.state ={
        CashbackComponentItems:
        [{
    ...
    return (
        <div className="row row-component">
            <h1 className="component-heading">Cashback</h1>
        <div className="col-12">
        <div className="row cards-items">
            {this.state.CashbackComponentItems.map( item =>(
